...
## Full Question Bank ('17-18 to '22-23)

> **Source:** BUET L-2/T-2 Term Final Examinations  
> **Years covered:** '17-18 · '18-19 · '19-20 · '20-21 · '21-22 · '22-23
...
| '19-20 | Q5(b) | 12 | Prove that minimum-weight connected edge subset must be a tree when all weights are positive; give counterexample for nonpositive weights |
...
| '19-20 | Q5(a) | 13 | Reduce a weighted graph (integer weights 1–5) to an unweighted SSSP problem solvable by BFS |
...
| '20-21 | Q1(b) | 12 | Solve minimum-sum descent in an equilateral number triangle using Dijkstra's algorithm |
...
| '20-21 | Q2(a) | 12 | Single-destination shortest paths in a graph with nonnegative vertex weights added to edge weights |
...
| '19-20 | Q7(c) | 12 | All-pairs shortest paths in a strongly connected graph restricted to paths through a fixed vertex v₀ |
...
| '18-19 | Q1(a) | 15 | *(See SSSP — also covers Dijkstra's complexity used inside Johnson's)* |
| '20-21 | Q2(b) | 10 | Warshall's algorithm in-place — no extra memory for intermediate matrices |
...
| '20-21 | Q3(b) | 10 | Gale-Shapley stable matching — can a woman benefit by falsely reordering her preference list? Prove your answer |
| '20-21 | Q4(a) | 15 | Determine edge connectivity of undirected G=(V,E) by running max-flow on at most \|V\| networks |
| '20-21 | Q4(b) | 7 | Define fixed-parameter tractability; explain why it is useful |
| '21-22 | Q4(a) | 8 | Define the max-flow problem |
| '21-22 | Q4(b)-i | 12 | Car-parking assignment — formulate as max-flow / min-cut problem |
| '21-22 | Q4(b)-ii | 15 | Car-parking assignment — develop efficient solution to minimize overall travel cost |
| '22-23 | Q1(b) | 23 | Peculiar city with gender-restricted road types — maximize roads under renovation while keeping connectivity; formulate, develop solution, write pseudocode |
...
| Year | Q | Marks | Topic |
|------|---|-------|-------|
| '17-18 | Q5(a) | 12 | Prove a height-balanced tree (children heights differ by ≤1) with n nodes has O(log n) height |
...
| '19-20 | Q4(b)-ii | 6 | Prove or disprove: minimum number of nodes in an AVL tree of height 5 is 20 |
...
| '18-19 | Q3(b)-ii | 7 | Delete key 6 from the splay tree obtained after part (i); show the result |
| '20-21 | Q6(a) | 5+10 | Define the rank of a splay tree node; prove that potential change from a non-splay insertion is O(log n) |
| '22-23 | Q3(a) | 8 | Explain how the potential function concept is used in the design of a splay tree |
...
| '20-21 | Q5(b) | 5+10 | Prove expected space of skip list is O(n); perform insert(17, i=2), insert(25, i=4), delete(25) on a given skip list |
| '20-21 | Q5(a) | 10 | A friend claims Find-Min in a binomial heap can be done in O(1) using Fibonacci heap idea; justify or refute |
...
| Year | Q | Marks | Topic |
|------|---|-------|-------|
| '18-19 | Q5(a) | 12 | Prove unsuccessful search under simple uniform hashing with separate chaining takes expected O(1+α) |
| '19-20 | Q1(a) | 10 | Prove successful search under simple uniform hashing with separate chaining requires expected O(1+α) |
| '19-20 | Q1(b) | 10 | N dinner guests arriving at a hash table — achieve 1+log α expected time for unsuccessful search |
| '21-22 | Q6(b) | 10 | Analyze running time of chaining hashtable for both successful and unsuccessful search |
| '17-18 | Q7(c) | 10 | Under simple uniform hashing with separate chaining (m chains, n items), find expected number of collisions with element x |

### Open Addressing & Probing

| Year | Q | Marks | Topic |
|------|---|-------|-------|
| '17-18 | Q7(d)-i | 5 | Prove or disprove: quadratic probing does not necessarily probe all locations in a hash table |
| '18-19 | Q5(b) | 6 | Agree or disagree: quadratic probing does not necessarily probe all locations; justify |
| '18-19 | Q5(c) | 12 | Insert keys 14,3,29,3,19,16,35,2 into hash table of size 11 using h(k)=k mod m and quadratic probing |
| '19-20 | Q1(c) | 15 | Insert keys into hash table of size 11 using (i) linear probing and (ii) quadratic probing |
| '20-21 | Q7(c) | 10 | Choose between separate chaining and open addressing for a new language's hash table; justify choice |

### Double Hashing & Comparison

| Year | Q | Marks | Topic |
|------|---|-------|-------|
| '22-23 | Q6(a)-i | 15 | Compare quadratic probing (size 16) vs double hashing (size 17) by counting total unsuccessful probes during insertion |
| '22-23 | Q6(a)-ii | 5 | Identify why key 150 is not found after deleting key 100 in the quadratic probing implementation; provide fix |
...
| Year | Q | Marks | Topic |
|------|---|-------|-------|
| '17-18 | Q7(a) | 4+6 | Define "maximally damaged tree" in Fibonacci heaps; draw the maximally damaged tree of order 5 |
| '17-18 | Q7(b) | 5 | Prove there are ᵏCᵢ nodes at depth i in binomial tree Bₖ |
| '18-19 | Q6(a) | 10 | Prove there are ᵏCᵢ nodes at depth i in binomial heap Bₖ of order k |
| '19-20 | Q2(a) | 10 | Prove there are ᵏCᵢ nodes at depth i in binomial heap Bₖ of order k |
| '22-23 | Q8(b) | 12 | Prove amortized cost of INSERT is O(1) and worst-case cost of EXTRACT-MIN and DECREASE-KEY is O(log n) |

### Operations & Complexity

| Year | Q | Marks | Topic |
|------|---|-------|-------|
| '17-18 | Q6(b) | 6+6 | State running times of Insert, Find-min, Extract-min, Union, Decrease-key for both binomial and Fibonacci heaps; evaluate friend's O(1)-all-ops claim |
...
| '20-21 | Q5(a) | 10 | Claim: Find-Min in binomial heap can be O(1) using Fibonacci heap idea — justify |
...
| '22-23 | Q8(a)-i | 8 | Insert given sequence into two initially empty binomial heaps pq1 and pq2; draw resulting heaps |
...
| '21-22 | Q5(e) | 5 | Compute total actual credits for the three Extract-Max operations in part (d) |
| '22-23 | Q8(b) | 12 | Prove amortized INSERT is O(1) and worst-case EXTRACT-MIN and DECREASE-KEY are O(log n) in binomial heap |
...
| '19-20 | Q2(c) | 8 | Draw the maximally damaged tree of degree 6 (i.e., f₆) in the context of Fibonacci heaps |
...
| Year | Q | Marks | Topic |
|------|---|-------|-------|
| '22-23 | Q5(c)-i | 6 | Construct an upper bound on actual time of RAHSUT-DELETE (variant delete) in terms of x.degree and cascading-cut calls c |
| '22-23 | Q5(c)-ii | 6 | Find the potential of the resulting heap H' after RAHSUT-DELETE in terms of x.degree, c, t(H), and m(H) |
...
| Year | Q | Marks | Topic |
|------|---|-------|-------|
| '17-18 | Q4(a) | 3+7 | Define X ≤ₚ Y; show vertex cover ≤ₚ set cover |
| '18-19 | Q7(a) | 12 | Prove P = NP ⟹ NP = co-NP |
| '18-19 | Q7(b) | 6 | Prove or disprove: TAUTOLOGY is in co-NP |
| '19-20 | Q3(a) | 8 | Suppose X ∈ NP-complete; prove X ∈ P if and only if P = NP |
| '20-21 | Q7(b) | 7+3 | Using an example show if a problem is in NP its complement is in co-NP; draw Venn diagram for P, NP, co-NP |
...
| '18-19 | Q7(c) | 12 | Prove vertex cover is at least as hard as independent set (reduction) |
...
| '22-23 | Q5(b) | 17 | Map the team task-scheduling problem to an NP-complete problem; reduce to another NP-complete problem to show NP-hardness |
...
| '17-18 | Q4(c) | 3+7 | Give approximation algorithm for set cover; compute approximation ratio |
| '18-19 | Q8(a) | 10 | Give 2-approximation algorithm for vertex cover; prove it computes a cover at most twice the optimal |
| '18-19 | Q8(a) | 10 | *(Same as above — vertex cover 2-approximation)* |
| '19-20 | Q8(a) | 12 | TSP near-optimal solution using minimum spanning tree (satisfies triangle inequality); construct and show on given graph |
| '20-21 | Q4(c) | 13 | Bottleneck TSP — design polynomial-time 3-approximation algorithm (triangle inequality assumed) |
| '20-21 | Q2(c) | 13 | Rumor spreading — design greedy algorithm minimizing messages needed for everyone to know all rumors |
| '21-22 | Q6(a) | 15+5+5 | Hashtable comparison problem — see Hashing section |
| '21-22 | Q8(b) | 15 | Apply FPTAS approximation algorithm (ε=0.1) to solve a given knapsack instance |
| '21-22 | Q8(a) | 5 | Why does the FPTAS use OPT(i,v) subproblem instead of OPT(i,w)? |
| '21-22 | Q8(c) | 15 | Prove the FPTAS computes a solution within (1+ε) of optimum in O(n³/ε) |
...
| Year | Q | Marks | Topic |
|------|---|-------|-------|
| '22-23 | Q7(a) | 20 | Solve a 4-city TSP using an exponential O(n²2ⁿ) dynamic programming algorithm; find optimal tour |
...
| Year | Q | Marks | Topic |
|------|---|-------|-------|
| '22-23 | Q7(a) | 20 | 4-city TSP — give O(n²2ⁿ) DP algorithm and find the optimal tour on the given cost matrix |
...
| '20-21 | Q3(b) | 10 | Gale-Shapley stable matching — prove whether a woman can manipulate the algorithm by falsely reordering preferences |
| '20-21 | Q3(c) | 15 | Jack Straws connectivity problem — give algorithm for all connected pairs |
...
| '19-20 | Q3(a) | 8 | If X is NP-complete, prove X ∈ P iff P = NP |
| '19-20 | Q7(a) | 13 | Vertex cover of a tree — give linear-time algorithm to find the size of the smallest vertex cover |
...
| '20-21 | Q5(d) | 5 | TSP lower bound via MST in branch-and-bound — will it always give the correct answer? Is there a better bound? |
| '21-22 | Q3(a) | 8 | Define the input/output of the Dhaka traffic road-building program |
| '21-22 | Q3(b) | 12 | Sketch pseudocode for the road-building solution (pick node pair (u,v) maximizing sum of shortest-path improvements) |
| '21-22 | Q3(c) | 15 | Develop the most efficient underlying algorithm (all-pairs shortest paths) for the road-building problem |
| '22-23 | Q5(c) | 12 | Analyze RAHSUT-DELETE — a modified Fibonacci heap delete operation (Professor Rahsut's variant) |
